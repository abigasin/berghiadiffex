...
do
	echo $file
	busco -m transcriptome -i ${file} -l /expanse/lustre/projects/sio138/shared/tools/busco_downloads/metazoa_odb10 -o ${file}_trinity.Trinity_metazoa.v4.0.5 -f -c 8
done
